...
徐延文編程語言。 [在线体验](http://xuyan-lang.lingdong.works/ide.html)
...
- [图灵完备](https://github.com/dtsdao/xuyan-lang/blob/master/examples/turing.wy)
- [在线 IDE](http://xuyan-lang.lingdong.works/ide.html)，即刻体验
- 通过[几个例子](https://github.com/dtsdao/xuyan-lang/tree/master/examples)快速入门
...
### [在线 IDE](http://xuyan-lang.lingdong.works/ide.html)
...
- 由[antfu](https://github.com/antfu)提供的[适用于VSCode的插件](https://github.com/antfu/xuyan-lang-vscode)
- 由[voldikss](https://github.com/voldikss)提供的[适用于Vim的插件](https://github.com/voldikss/vim-xuyan)
- 由[absop](https://github.com/absop)提供的[适用于Sublime Text的插件](https://github.com/absop/Sublimexuyan)
...
`src/render.js` 脚本文件能把 `wy` 代码格式化输出成为古汉语书籍样式（历史印刷书籍）的矢量图（SVG）。同时它还可以将生成的SVG文件解析回原始徐延代码。需要获取更详细的信息，请使用`xuyan -h`命令来获取帮助。

下图是用 xuyan 编写的 通用图灵机程序 渲染而成。
...
|名称|优先级|需要帮助|状态|
|---|---|---|---|
|[语言规范](https://github.com/dtsdao/xuyan-lang/issues/1)|  ***** | | 正在进行中 |
|[类](https://github.com/dtsdao/xuyan-lang/issues/31) / [对象文法](https://github.com/dtsdao/xuyan-lang/issues/20) |  *** | | 对象文法已经添加 |
|[导入语句](https://github.com/dtsdao/xuyan-lang/issues/100) |  *** | | 导入语句已经添加 |
|标准库 ([Math(数学)](https://github.com/dtsdao/xuyan-lang/issues/55)/[Bitwise ops(位运算)](https://github.com/dtsdao/xuyan-lang/issues/2)/[Random(随机)](https://github.com/dtsdao/xuyan-lang/issues/87)) |  ***** | √ | 正在进行中 |
|[测试套件](https://github.com/dtsdao/xuyan-lang/issues/38)|  **** | √ | 正在进行中 |
|[Switch语句](https://github.com/dtsdao/xuyan-lang/issues/53)|  *** | | |
|[函数式程序设计](https://github.com/dtsdao/xuyan-lang/issues/99) |  *** | | |
|更严格的编译器 |  **** | | |
|其他语言的编译器 |  ** | √ | |
|[编辑器的插件](https://github.com/dtsdao/xuyan-lang/issues/77) |  ** | √ | 适用于VSCode, Vim, Sublime的插件已添加 |
|将 [js](https://github.com/dtsdao/xuyan-lang/issues/47)/[py](https://github.com/dtsdao/xuyan-lang/issues/67)/[anything](https://github.com/dtsdao/xuyan-lang/issues/73) 转换回 xuyan(徐延) |  * | √ | |
|[转义](https://github.com/dtsdao/xuyan-lang/issues/84)/[生成](https://github.com/dtsdao/xuyan-lang/issues/128) 特殊符号 |  *** | | |
|[对「「」」的替换语法](https://github.com/dtsdao/xuyan-lang/issues/81)|  ** | | |
|[对 。的替换语法](https://github.com/dtsdao/xuyan-lang/issues/93)|  ** | | |
|在线 IDE 的 [字体](https://github.com/dtsdao/xuyan-lang/issues/5) 和 [垂直文本](https://github.com/dtsdao/xuyan-lang/issues/9) |  ** | | |
|[将注释呈现为小型内联文本](https://github.com/dtsdao/xuyan-lang/issues/148) | ** | | |
|更多示例 | ** | √ | |
...
|名称|优先级|需要帮助|状态|
|---|---|---|---|
|[汉字到数字的转换问题](https://github.com/dtsdao/xuyan-lang/issues/114)|  ***** | | |
|[汉字到数字转换中多字符数字没有被加入支持](https://github.com/dtsdao/xuyan-lang/issues/130) |  *** | | |
